$(document).ready(function()
{
	...
	let color2="#ff5500"
	let color3="#2f4e47"
	let patasxan="congratulations"
	let patasxan2="No one"
	let patasxan3="Winer is"
	let yntrel=""
	let languake
	let k=true
	let Count=0
	...
	$("#change").click(function()
	{
		...
		if(languake=="հայերեն")
		{
			...
			$("#change").html("Փոփոխել")
			$("#con").html("Հաշիվ")
			$('#verjnakanHashiv').attr('placeholder', 'Հաշիվ')
			patasxan="շնորհավոր"
			patasxan2="ոչ ոքի"
			patasxan3="Խաղը հաղտեց"
		}
			...
			$("#change").html("Change")
			$("#con").html("Count")
			$('#verjnakanHashiv').attr('placeholder', 'Count')
			patasxan="congratulations"
			patasxan2="No one"
			patasxan3="Winer is"
		}
	...
	$("td").click(function(){
		verjnakan=$("#verjnakanHashiv").val()
		if($("#verjnakanHashiv").val()==""){
			verjnakan=100000
		}
		...
		if($(this).html()=="")
		{
			...
			if(b){
				...
				if(hashivo==verjnakan){
					setTimeout(function(){

					alert(patasxan3+" "+xax2)
					hashivo=0
					hashivx=0
					$("#ohashiv").html(hashivo)
					$("#xhashiv").html(hashivx)
					},600)
					console.log("Winer "+xax2)

				}
				else if(hashivx==verjnakan){
					setTimeout(function(){

					alert(patasxan3+" "+xax1)
					hashivo=0
					hashivx=0
					$("#xhashiv").html(hashivx)
					$("#ohashiv").html(hashivo)
					},600)
					console.log("Winer "+xax1)
